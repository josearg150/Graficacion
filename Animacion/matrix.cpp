...
Matrix &Matrix:: rotacion(Matrix f, Matrix id, float ang){
...
Matrix &Matrix:: rotacionPuntoPivote(Matrix f, Matrix id, float ang, float ppx, float ppy){
    ...
    float ren20=ppx*(1-coseno)+ppy*seno;
    float ren21=-ppx*seno+ppy*(1-coseno);
